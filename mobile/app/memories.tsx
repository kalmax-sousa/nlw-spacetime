          ...
          <View key={memory.id} className="space-y-4">
            ...
            <View className="space-y-4 px-8">
              ...
              <Text className="font-body text-base leading-relaxed text-gray-100">
                ...
                deleniti odio velit impedit provident voluptates fugiat esse
                repudiandae, officia, nesciunt, exercitationem ipsa qui!
                Blanditiis architecto, tenetur deserunt eius amet veritatis.
              </Text>
